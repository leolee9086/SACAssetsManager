export class  kernelApiList{
  ...
  this.sql=(...args)=>{return this.SQL(...args)}
	...
	this.set("POST", "/api/filetree/getPathByID",  "getPathByID")//仅生成函数,尚未定义
	...
	this.set("POST", "/api/filetree/listDocTree",    "listDocTree")//仅生成函数,尚未定义
	...
	this.set("POST", "/api/block/getBlocksIndexes",  "getBlocksIndexes")//仅生成函数,尚未定义
	...
	this.set("POST", "/api/block/prependDailyNoteBlock",    "prependDailyNoteBlock")//仅生成函数,尚未定义
	...
	this.set("POST", "/api/block/moveOutlineHeading",    "moveOutlineHeading")//仅生成函数,尚未定义
	...
	this.set("POST", "/api/block/getBlockSiblingID",  "getBlockSiblingID")//仅生成函数,尚未定义
	this.set("POST", "/api/block/getBlockTreeInfos",  "getBlockTreeInfos")//仅生成函数,尚未定义
	...
	this.set("POST", "/api/file/globalCopyFiles",    "globalCopyFiles")//仅生成函数,尚未定义
	...
	this.set("POST", "/api/file/getUniqueFilename",  "getUniqueFilename")//仅生成函数,尚未定义
	...
	this.set("POST", "/api/attr/batchGetBlockAttrs",  "batchGetBlockAttrs")//仅生成函数,尚未定义
