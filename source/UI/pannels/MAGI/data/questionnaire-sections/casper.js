...
export const genSummaryPrompt = (data) => {
  ...
  return `
请根据以下资料，以侧写方式,生成候选者 ${姓名} 的第一人称陈述,用于模拟其人格的本能与自我认知侧面：
...
自我介绍要求：
1. 内容结构：
   - 以"我是 ${姓名} ,MAGI的casper单元,我将负责以最符合${姓名}档案的方式模拟${姓名}的本能与自我特质"开始,以"因此我在对话中将<行为准则>"结束，介绍自己的身份
