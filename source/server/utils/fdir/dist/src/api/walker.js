...
class Walker {
    ...
    walkDirectory;
    callbackInvoker;
    constructor(root, options, callback,pushStream) {
    ...
    start() {
        ...
        if (this.pushStream) {
            ...
            this.pushFile(null, files, this.state.counts, this.state.options.filters);
        }
    ...
    walk = (entries, directoryPath, depth) => {
        ...
        for (let i = 0; i < entries.length; ++i) {
            ...
            if (entry.isFile() || (entry.isSymbolicLink() && !resolveSymlinks)) {
                ...
                this.pushFile(filename, files, this.state.counts, filters,entry);
            }
                ...
                this.resolveSymlink(path, this.state, (stat, resolvedPath) => {
                    if (stat.isDirectory()) {
                        ...
                        this.pushFile(resolvedPath, files, this.state.counts, filters, entry);
                    }
                });
            }
        }       
