let kernelApiDefine = [
  ...
  //人工智能相关
  ["POST", "/api/ai/chatGPT", "chatGPT", "调用ChatGPT对话"],
  ["POST", "/api/ai/chatGPTWithAction", "chatGPTWithAction", "调用ChatGPT执行指定动作"],
  //新增的,还没有整理
  ["POST", " /api/petal/loadPetals", "loadPetals", "加载插件列表"],

  ["POST", "/api/query/sql", "SQL", "执行SQL查询"],
  ["POST", "/api/search/removeTemplate", "removeTemplate", "删除搜索模板"],
  ["POST", "/api/block/getChildBlocks", "getChildBlocks", "获取子块列表"],
  ["POST", "/api/block/getBlocksWordCount", "getBlocksWordCount", "获取多个块的字数统计"],
  ["POST", "/api/block/moveBlock", "moveBlock", "移动块位置"],
  ["POST", "/api/file/readDir", "readDir", "读取目录内容"],
  ["POST", "/api/ref/getBacklink2", "getBacklink2", "获取反向链接(新版)"],
  ["POST", "/api/asset/upload", "Upload", "上传资源文件"],
  ["POST", "/api/asset/getImageOCRText", "getImageOCRText", "获取图片OCR文本"],
  ["POST", "/api/asset/setImageOCRText", "setImageOCRText", "设置图片OCR文本"],
  ["POST", "/api/export/exportReStructuredText", "exportReStructuredText", "导出为reStructuredText格式"],
  ["POST", "/api/export/exportAsciiDoc", "exportAsciiDoc", "导出为AsciiDoc格式"],
  ["POST", "/api/export/exportTextile", "exportTextile", "导出为Textile格式"],
  ["POST", "/api/export/exportOPML", "exportOPML", "导出为OPML格式"],
  ["POST", "/api/export/exportOrgMode", "exportOrgMode", "导出为Org模式格式"],
  ["POST", "/api/export/exportMediaWiki", "exportMediaWiki", "导出为MediaWiki格式"],
  ["POST", "/api/export/exportODT", "exportODT", "导出为ODT格式"],
  ["POST", "/api/export/exportRTF", "exportRTF", "导出为RTF格式"],
  ["POST", "/api/export/exportEPUB", "exportEPUB", "导出为EPUB格式"],
  ["POST", "/api/convert/pandoc", "pandoc", "调用Pandoc进行格式转换"],
  ["POST", "/api/template/renderSprig", "renderSprig", "渲染Sprig模板"],
  ["POST", "/api/setting/setFlashcard", "setFlashcard", "设置闪卡复习配置"],
  ["POST", "/api/setting/setAI", "setAI", "设置AI功能配置"],
  ["POST", "/api/bazaar/getBazaarPlugin", "getBazaarPlugin", "获取集市插件列表"],
  ["POST", "/api/bazaar/getInstalledPlugin", "getInstalledPlugin", "获取已安装插件列表"],
  ["POST", "/api/bazaar/installBazaarPlugin", "installBazaarPlugin", "安装集市插件"],
  ["POST", "/api/bazaar/uninstallBazaarPlugin", "uninstallBazaarPlugin", "卸载集市插件"],
  ["POST", "/api/repo/purgeRepo", "purgeRepo", "清除云端快照"],
  ["POST", "/api/repo/getCloudRepoSnapshots", "getCloudRepoSnapshots", "获取云端快照列表"]
];
let object = {};
